...
function shouldBehaveLikeTokenDealer (investor, wallet, rate, bonus) {
    ...
    describe('accepting payments', function () {
      describe('bare payments', function () {
        ...
        it('reverts on zero-valued payments', async function () {
          await expectRevert(
            this.crowdsale.send(0, { from: investor }), 'TokenDealer: weiAmount is 0'
          );
        });
      });
      ...
      describe('buyTokens', function () {
        ...
        it('reverts on zero-valued payments', async function () {
          await expectRevert(
            this.crowdsale.buyTokens({ value: 0, from: investor }), 'TokenDealer: weiAmount is 0'
          );
        });
      });
    });
